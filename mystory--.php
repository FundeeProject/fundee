...
<!--
<div id = "showAllPage" class = "showAllPage"> 
	<form class="marginT20" style="width :90%; margin-left:auto; margin-right:auto; ">
		<div class="form-group">
			<label for="">Story Name</label>
			<input type="text" class="form-control" id="showStoryname"  placeholder="">
			<input type="text" class="form-control" id="showStoryid"  placeholder="">
		</div>
	</form>
	<div id = "showpic_Allpage"> 
	</div>
	<div class="btn-confirm">
...
<div id = "showAllPage" class="marginAuto myStoryPage showAllPage"  >
	<form class="marginT20 marginAuto" style="width :90%;"  >
		  <p class="textName">Story Name : <span id="showStoryname"></span></p>
		  <input type="hidden" class="form-control" id="showStoryid"><!--ซ่อน-->
...
<div id = "showCreateTitle" class = "showCreateTitle"> 
	<form class="marginT20" style="width :90%; margin-left:auto; margin-right:auto; "  method = "post" enctype = "multipart/form-data" id = "createform2">
		...
		<div class="form-group">
			...
			<div class="box-img" style="" id = "showPic_page">
			...
			<input type="file" name="pic_upload_page" OnChange="PreviewPage(this)"/>
		</div>
					...
					success:function( datajson ) {     
						if(datajson.length !=0){
							...
							$.each(datajson, function(i,item){
							 var no =i+1;
							 if(datajson[i].picture == 'NULL' ){
								var img = " <button id = 'pic_' value ='"+no+"' onClick = 'pageAddpicture(this.value);' > <img src ='imgStory/img_00.png' style=' width: 90px; height: 90px;' />  </button> "; 
							 }else{
								var img = " <button id = 'pic_' value ='"+no+"' onClick = 'pageAddpicture(this.value);' > <img src ='imgStory/"+ datajson[i].picture + "'  style=' width: 90px; height: 90px;' />  </button>"; 
							 }
								//var img = $('<tr><td align="center">'+datajson[i].date_borrow+'</td><td align="center">'+datajson[i].date_rent+'</td><td align="center">'+datajson[i].user_id+'</td><td align="center">'+datajson[i].tec_give_id+'</td><td align="center">'+ datajson[i].tec_rent_id+'</td></tr>');
								$('#showpic_Allpage').append(img);	
							});	
...
function PreviewPage(ele) {  // แสดงรูปที่เลือก เพจ
	...
	showPic_page.innerHTML = "<img id='img2' src='' alt='' style=' width: 90px; height: 90px;' />";
