	...
	<form class="form-horizontal" method="post" name="" id="">
		...
		<div id="showStory" class="form-group">
			<div class="col-xs-4 col-lg-2  boxImg"> 
				<div class="h100 viewDetail" data-img="84"> 
					<div class="img"  style="background:url(imgStory/84_00.png)"></div> 
...
function seeStory(pageNumber) { /// กดเลือกเพื่อดู / แก้ไข นิทาน
	//alert(pageNumber);
	window.location.href="main.php?page=play_storydetail&storyID="+pageNumber+"";
}
</script>
